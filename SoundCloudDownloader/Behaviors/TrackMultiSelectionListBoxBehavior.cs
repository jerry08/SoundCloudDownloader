...
{
    public class TrackMultiSelectionListBoxBehavior : Behavior<ListBox>
    {
        public static readonly DependencyProperty SelectedItemsProperty =
            DependencyProperty.Register(nameof(SelectedItems), typeof(IList),
                typeof(TrackMultiSelectionListBoxBehavior),
                new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault,
                    OnSelectedItemsChanged));

        private static void OnSelectedItemsChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args)
        {
            var behavior = (TrackMultiSelectionListBoxBehavior) sender;
        ...
        private void OnListBoxSelectionChanged(object sender, SelectionChangedEventArgs args)
        {
            ...
            SelectedItems = AssociatedObject.SelectedItems.Cast<TrackInformation>().ToArray();
        }
