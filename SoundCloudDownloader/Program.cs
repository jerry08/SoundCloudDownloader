...
public static class Program
{
    ...
    public static string Name { get; } = Assembly.GetName().Name ?? "SoundCloudDownloader";
    ...
    public static string ProjectUrl { get; } = "https://github.com/jerry08/SoundCloudDownloader";
